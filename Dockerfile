...
# run [docker run --name bank_transfer --network bank-network -p 8080:8080 -e GIN_MODE=release -e DB_SOURCE="postgresql://root:12345678@postgres12:5432/transfer_bank?sslmode=disable" bank_transfer:latest] to run golang image
